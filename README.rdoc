...
The major principles used for this app include the nested resources, devise and associations. In addition to that, Twitter Bootstrap Basic was also used to implement the interface components.
